...
model_path = "/Users/kj/Library/CloudStorage/OneDrive-한림대학교/연구 및 과제/박사논문/after30/model.pickle.dat"
model = pickle.load(open(model_path, "rb"))
explainer = shap.TreeExplainer(model)


display_name = pd.read_excel("/Users/kj/Library/CloudStorage/OneDrive-한림대학교/연구 및 과제/박사논문/after30/feature_list_Display_name after30.xlsx")
...
st.markdown('<span style="font-size: 40px;">Prediction of bloodstream infection within 30 days after positive rectal CRE surveillance culture</span><span style="font-size: 18px;">&nbsp;&nbsp;&nbsp; by K.Jeon</span>', unsafe_allow_html=True)
